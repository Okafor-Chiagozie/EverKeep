      ...
      <div className="p-3 sm:p-4 md:p-6 lg:p-8 space-y-4 sm:space-y-6 lg:space-y-8">
        ...
        >
          <Tabs defaultValue="account" className="space-y-4 sm:space-y-6">
            <TabsList className="grid w-full grid-cols-2 lg:grid-cols-4 bg-slate-900/50 border border-slate-700 h-auto">
              <TabsTrigger value="account" className="data-[state=active]:bg-blue-600 text-xs sm:text-sm py-2 sm:py-3">
                <User className="w-3 h-3 sm:w-4 sm:h-4 mr-1 sm:mr-2" />
                <span className="hidden sm:inline">Account</span>
                <span className="sm:hidden">Account</span>
              </TabsTrigger>
              <TabsTrigger value="security" className="data-[state=active]:bg-blue-600 text-xs sm:text-sm py-2 sm:py-3">
                <Shield className="w-3 h-3 sm:w-4 sm:h-4 mr-1 sm:mr-2" />
                <span className="hidden sm:inline">Security</span>
                <span className="sm:hidden">Security</span>
              </TabsTrigger>
              <TabsTrigger value="delivery" className="data-[state=active]:bg-blue-600 text-xs sm:text-sm py-2 sm:py-3">
                <Clock className="w-3 h-3 sm:w-4 sm:h-4 mr-1 sm:mr-2" />
                <span className="hidden sm:inline">Delivery</span>
                <span className="sm:hidden">Delivery</span>
              </TabsTrigger>
              <TabsTrigger value="notifications" className="data-[state=active]:bg-blue-600 text-xs sm:text-sm py-2 sm:py-3">
            ...
            <TabsContent value="notifications" className="space-y-4 sm:space-y-6">
              ...
              <Card className="p-4 sm:p-6 bg-red-900/20 border-red-500/30">
                ...
                <div className="space-y-4">
                  ...
                  <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between space-y-3 sm:space-y-0">
                    <div>
                      <h4 className="font-medium text-white text-sm sm:text-base">Revoke All Deliveries</h4>
                      <p className="text-xs sm:text-sm text-slate-400">Cancel all scheduled vault deliveries</p>
                    </div>
                    <Button variant="outline" className="border-red-500/50 text-red-400 hover:bg-red-500/10 w-full sm:w-auto" size="sm">
                      Revoke Deliveries
                    </Button>
                  </div>
                </div>
