    ...
    <div className="flex h-screen w-full bg-slate-900 overflow-hidden">
      ...
      <div className="lg:hidden fixed top-4 right-4 z-50">
        <Button
          ...
          className="bg-slate-900/90 backdrop-blur-xl border-slate-700/50 shadow-lg"
        >
      ...
      <motion.div
        ...
        className={`
          fixed left-0 top-0 h-screen w-80 bg-slate-800/95 backdrop-blur-xl border-r border-slate-700/50 z-50 shadow-2xl
                ...
                <div className="space-y-3">
                  <div className="relative">
                    <textarea
                      ...
                      className="w-full bg-slate-800/50 border border-slate-600 rounded-lg px-3 py-3 text-white placeholder:text-slate-400 resize-none focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all duration-200 custom-scrollbar"
                      style={{
                        minHeight: '44px',
                        maxHeight: '200px',
                        height: '44px'
