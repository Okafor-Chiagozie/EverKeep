...
export function Dashboard() {
  ...
  const checkInProgress = ((60 - daysUntilCheck) / 60) * 100;
    ...
    <div className="p-4 sm:p-6 lg:p-8 space-y-6 lg:space-y-8 min-h-screen">
        ...
        <Card className="p-4 sm:p-6 bg-gradient-to-r from-blue-900/20 to-purple-900/20 border-blue-500/30">
          <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between mb-4 space-y-4 sm:space-y-0">
            <div className="flex items-center space-x-3">
              ...
              <div>
                <h3 className="text-lg sm:text-xl font-semibold text-white">Deadman Switch Status</h3>
                <p className="text-sm text-slate-400">Next check-in required</p>
              </div>
            </div>
          ...
          <div className="flex flex-col sm:flex-row items-center justify-between space-y-3 sm:space-y-0 sm:space-x-4">
            <Button 
              variant="outline" 
              className="w-full sm:w-auto border-blue-500/50 text-blue-400 hover:bg-blue-500/10"
            >
      ...
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 lg:gap-6">
        {[
          ...
          >
            <Card className="p-4 sm:p-6 bg-slate-900/50 backdrop-blur-sm border-slate-700/50 hover:border-slate-600/50 transition-colors">
              <div className="flex items-center justify-between mb-3 sm:mb-4">
                <div className={`w-8 h-8 sm:w-12 sm:h-12 rounded-xl bg-${stat.color}-500/20 flex items-center justify-center`}>
              ...
              <div className="space-y-1">
                ...
                <p className="text-xs sm:text-sm font-medium text-slate-300">{stat.title}</p>
